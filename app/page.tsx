    ...
    <main className="garage-sheet">
      ...
      <section className="mt-8">
        ...
        <ul>
          ...
          <li>
            Membre du Comité départemental du jeu d’échecs des Hauts-de-Seine — <a className="garage-link" href="https://www.echecs92.com/comite" target="_blank" rel="noopener noreferrer">echecs92.com/comite</a>
          </li>
          <li>
